...
{
    public class StarPlasma : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("StarPlasna");     //The English name of the projectile
        ...
        public override void SetDefaults()
        {
            ...
            projectile.aiStyle = 44;             //The ai style of the projectile, please reference the source code of Terraria
