...
{
    public class Duskmourne : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Duskmourne Beam");     //The English name of the projectile
        ...
        public override void SetDefaults()
        {
            ...
            projectile.penetrate = 25;           //How many monsters the projectile can penetrate. (OnTileCollide below also decrements penetrate for bounces as well)
